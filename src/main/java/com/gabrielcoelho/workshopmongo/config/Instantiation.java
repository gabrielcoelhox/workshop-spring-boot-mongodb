...
import com.gabrielcoelho.workshopmongo.dto.AuthorDTO;
import com.gabrielcoelho.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2022"), "Partiu viagem", "Vou viajar para João Pessoa. Abraços!", new AuthorDTO(maria));
