...
import com.gabrielcoelho.workshopmongo.dto.UserDTO;
import com.gabrielcoelho.workshopmongo.repository.UserRepository;
import com.gabrielcoelho.workshopmongo.services.exception.ObjectNotFoundException;
...
public class UserService {
	...
	public User update(User obj) {
		User newObj = findById(obj.getId()); //Obj original do BD
